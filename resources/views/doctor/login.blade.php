...
<head>
    ...
    <style>
        ...
        body { font-family: sans-serif; background: linear-gradient(135deg, #0a6ebd, #0d1b2a); min-height: 100vh; display: flex; align-items: center; }
        ...
        .login-icon { width: 75px; height: 75px; background: linear-gradient(135deg, var(--primary), var(--secondary)); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 2rem; color: white; margin: 0 auto 20px; }
        ...
        .btn-login { background: var(--primary); color: white; border: none; padding: 13px; width: 100%; border-radius: 12px; font-size: 1rem; font-weight: 600; margin-top: 10px; }
        .btn-login:hover { background: #085a9e; color: white; }
...
<div class="container">
    <div class="login-box">
        ...
        <div class="login-sub">MediCare Doctor Portal</div>
        ...
        <form method="POST" action="/doctor/login">
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control"
                    placeholder="doctor@email.com" value="{{ old('email') }}" required>
            </div>
            <div class="mb-3">
